...
label Emma_Date_Ask:
    ...
    menu:
        "Good, I'll meet you in the campus square." if bg_current != "bg campus":  
                    call EmmaFace("smile")
        "Good, let's get going then." if bg_current == "bg campus":  
                    call EmmaFace("smile")
    ...
    menu:
            ...
            "Yeah, I found something better to do.": 
                if ApprovalCheck("Emma", 1200, "LO"):
                        ...
                        $ E_RecentActions.append("angry") 
                        $ E_DailyActions.append("angry")  
                        $ E_Love = Statupdate("Emma", "Love", E_Love, 80, -15)
                        $ E_Inbt = Statupdate("Emma", "Inbt", E_Inbt, 60, 5) 
...
label Emma_Dinner_Sex(Previous=0,E_Bonus=0,Options=["nothing"]):
    ...
    if Options[0] == "nothing":
        ...
        if _return == 4: #you refused
                ...
                $ E_Inbt = Statupdate("Emma", "Inbt", E_Inbt, 50, 9)
        ...
        if _return == 4: #you refused
                ...
                $ E_Inbt = Statupdate("Emma", "Inbt", E_Inbt, 50, 8)
        ...
        if _return == 4: #you refused
                ...
                $ E_Inbt = Statupdate("Emma", "Inbt", E_Inbt, 50, 6)
                $ E_Inbt = Statupdate("Emma", "Inbt", E_Inbt, 80, 2)
        ...
        if _return == 4: #you refused
                ...
                $ E_Love = Statupdate("Emma", "Love", E_Love, 90, -7)
                $ E_Obed = Statupdate("Emma", "Obed", E_Obed, 70, 3)
                $ E_Inbt = Statupdate("Emma", "Inbt", E_Inbt, 80, -5)
                call Date_Bonus("Emma",-3)
        else:
                ...
                $ E_Inbt = Statupdate("Emma", "Inbt", E_Inbt, 30, 5)            
...
label Emma_Movie_Sex(Previous=0,E_Bonus=0, Options=["nothing"]):
    ...
    if ApprovalCheck("Emma", 500, Bonus=(10*E_Bonus)):
        ...
        if E_Anal and ApprovalCheck("Emma", 2000, Bonus=(10*E_Bonus)) and PantsNum("Emma") < 5:
                    ...
                    $ E_Inbt = Statupdate("Emma", "Inbt", E_Inbt, 90, 3)
                    $ E_SeenPeen += 1
                    $ E_Anal += 1
                    $ P_Semen -= 1
                    $ E_RecentActions.append("anal")                      
...
label E_Date_End:   
    ...
    if bg_current != "bg player":
        ...
        #    $ bg_current = "bg emma" # fix all this when Emma's room is ready
        #    $ E_Loc = "bg emma"
            if "Rogue" in Party:
                $ R_Loc = "bg player" #"bg emma"
            if "Kitty" in Party:
                $ K_Loc = "bg player" #"bg emma"
    ...
    if Count < 0:      
        ...
        ch_e "Actually, I'm still getting set up, we can part at your room."
        if Count > 20:
            call EmmaFace("sexy", 1)            
            if bg_current == "bg player":
    ...
    call Emma_Sleepover 
    jump Player_Room #Emma_Room #should never be reached
