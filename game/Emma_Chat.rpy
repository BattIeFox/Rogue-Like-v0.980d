...
label Emma_Chat:
    ...
    menu:
        ...
        "Lock the door" if bg_current == "bg classroom" and "lockedclass" not in P_RecentActions:
        ...
        "Unlock the door" if bg_current == "bg classroom" and "lockedclass" in P_RecentActions:
                ...
                menu:
                    ...
                    "I insist, put some on.":
                        if (E_Love+E_Obed) <= E_Inbt:
                            call EmmaFace("angry", Eyes="side")
                            $ E_Inbt = Statupdate("Emma", "Inbt", E_Inbt, 99, 5)
                            $ E_Obed = Statupdate("Emma", "Obed", E_Obed, 80, -5)
...
label E_Private_Outfit:
    ...
    if "comfy" in E_RecentActions:
            call E_AltClothes(9)
            call EmmaOutfit(Changed=1)
    elif "no comfy" in E_RecentActions:
            pass        
    elif (2 * E_Inbt) >= (E_Love + E_Obed) or "comfy" in E_Traits:
