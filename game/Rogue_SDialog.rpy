...
label Dirty_Talk(D20=0, TempCheck=0, TempLine=0, TempTrigger=Trigger4, ActiveGirl=0): 
    ...
    $ D20 = renpy.random.randint(1, 20)  
    #Rogue    
    if (Primary == "Rogue" and D20 <= 10) or (Secondary == "Rogue" and Trigger4 and 11 <= D20 <= 15):
            ...
            if Trigger == "lesbian" or (Secondary == "Rogue" and TempTrigger not in ("hand","blow","masturbation")):
                    #if this is a lesbian action, or if the threesome action is girl-focused                    
                    if "unseen" not in R_RecentActions and 8<=D20<=12:
                    ...
                    if not TempLine or D20 <= 3 or D20 >= 14:
                    ...
                    if "unseen" not in R_RecentActions and 5<=D20<=13:
                    ...
                    if R_SEXP <= 20 or TempCheck == "kiss you":
                        ...
                        if 9<=D20<=11 and TempCheck == "anal" and R_Loose <= 1:
            ...
            if Trigger == "lesbian" and ("unseen" in K_RecentActions or 8<=D20<=17):
                    if Primary == "Kitty":
                        $ ActiveGirl = Secondary
                    else:
                        $ ActiveGirl = Primary
            ...
            #procs if she's prinary under 10, or secondary over 15
            if Trigger == "lesbian" and ("unseen" in E_RecentActions or 8<=D20<=17):
                    if Primary == "Emma":
                        $ ActiveGirl = Secondary
                    else:
                        $ ActiveGirl = Primary
