...
#    "1 - [Resolution] and [R_Cheated]" #remove, diagnostic
...
#    "2 - [Resolution] and [R_Cheated]" #remove, diagnostic
...
#        "5 - [Resolution] and [R_Cheated] and [B]" #remove, diagnostic
    
#    "3 - [Resolution] and [R_Cheated]" #remove, diagnostic
    
    $ Resolution -= R_Cheated if R_Cheated <= 3 else 3 #Adds to Resolution 3 or less based on cheating
    
#    "4 - [Resolution] and [R_Cheated]" #remove, diagnostic
